...
public class SSSrv_ApiMobileBankingImp implements SSSrv_ApiMobileBanking {
	...
	@Override
	public String LinkAccountToCard(SSEnt_LinkAccountToCardRq linkaccounttocard) {
		    String baseRs;
		    SSEnt_Header header = linkaccounttocard.getHeader(); 
		    SSRepo_LinkAccountToCard linkacccard = new SSRepo_LinkAccountToCard(linkaccounttocard);
		    baseRs = linkacccard.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String CardRisk(SSEnt_CardRiskRq cardrisk) {
		    String baseRs;
		    SSEnt_Header header = cardrisk.getHeader(); 
		    SSRepo_CardRisk cardRisk = new SSRepo_CardRisk(cardrisk);
		    baseRs = cardRisk.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String RiskCardUpdate(SSEnt_RiskCardUpdateRq cardriskup) {
		    String baseRs;
		    SSEnt_Header header = cardriskup.getHeader(); 
		    SSRepo_RiskCardUpdate cardRiskupd = new SSRepo_RiskCardUpdate(cardriskup);
		    baseRs = cardRiskupd.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String UpdateRiskCardNew(SSEnt_UpdateRiskCardNewRq risk) {
		    String baseRs;
		    SSEnt_Header header = risk.getHeader(); 
		    SSRepo_UpdateRiskCardNew cardRiskupdnew = new SSRepo_UpdateRiskCardNew(risk);
		    baseRs = cardRiskupdnew.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String UnLinkAccountToCard(SSEnt_UnLinkAccountToCardRq unlinkaccounttocard) {
		    String baseRs;
		    SSEnt_Header header = unlinkaccounttocard.getHeader(); 
		    SSRepo_UnLinkAccountToCard unlinkacccard = new SSRepo_UnLinkAccountToCard(unlinkaccounttocard);
		    baseRs = unlinkacccard.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String ChangeMagPin(SSEnt_ChangeMagPinRq changemagpin) {
		    String baseRs;
		    SSEnt_Header header = changemagpin.getHeader(); 
		    SSRepo_ChangeMagPin changemagpi = new SSRepo_ChangeMagPin(changemagpin);
		    baseRs = changemagpi.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String AnonymDebitCard(SSEnt_AnonymDebitCardRq anonymdebitcard) {
		    String baseRs;
		    SSEnt_Header header = anonymdebitcard.getHeader(); 
		    SSRepo_AnonymDebitCard anonydebitcard = new SSRepo_AnonymDebitCard(anonymdebitcard);
		    baseRs = anonydebitcard.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String GetMerchantTransaction(SSEnt_MerchantTransactionsRq merchanttransactions) {
		    String baseRs;
		    SSEnt_Header header = merchanttransactions.getHeader(); 
		    SSRepo_MerchantTransactions MerchantTransactions = new SSRepo_MerchantTransactions(merchanttransactions);
		    baseRs = MerchantTransactions.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String AcceptPayment(SSEnt_AcceptPaymentRq paymentreq) {
		    String baseRs;
		    SSEnt_Header header = paymentreq.getHeader(); 
		    SSRepo_AcceptPayment paymentrequ = new SSRepo_AcceptPayment(paymentreq);
		    baseRs = paymentrequ.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String ReverseAuth(SSEnt_ReverseAuthRq revreq) {
		    String baseRs;
		    SSEnt_Header header = revreq.getHeader(); 
		    SSRepo_ReverseAuth reversereq = new SSRepo_ReverseAuth(revreq);
		    baseRs = reversereq.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
	...
	@Override
	public String UpdateCardDomainType(SSEnt_UpdateCardDomainTypeRq updcardomainrq) {
		    String baseRs;
		    SSEnt_Header header = updcardomainrq.getHeader(); 
		    SSRepo_UpdateCardDomainType updcardomainrqe = new SSRepo_UpdateCardDomainType(updcardomainrq);
		    baseRs = updcardomainrqe.processing(dataSource);
		    String finalResponse;
		    try {
		        ObjectMapper mapper = new ObjectMapper();
		        JsonNode responseBody = mapper.readTree(baseRs);
